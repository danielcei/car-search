    ...
    <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="bg-gray-800 p-4 rounded-lg">
                    ...
                    <div class="space-y-2 max-h-60 overflow-y-auto p-1">
                        @foreach($brands as $brand)
                            <label class="flex items-center space-x-3 cursor-pointer hover:bg-gray-700 rounded px-2 py-1">
                                <input
                                    type="checkbox"
        ...
        <div class="lg:w-3/4 w-full">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach($cars as $car)
                    <div class="bg-gray-900 rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition-transform duration-300">
                        <img
